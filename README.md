...
- возможность крупного отображения одного из следующих показателей:
  время / СО2 / давление / влажность / температура.

Вывод часовых и суточных графиков изменения СО2, температуры, влажности,
давления, вероятности осадков. Есть возможность скрыть ненужные графики
в настройках.

<<<<<<< HEAD
Так же есть возможность отображения высоты над уровнем моря. Вычисляется 
из атмосферного давления, поэтому может изменяться в широких пределах.

=======
>>>>>>> 20acccf52ebbd4796552511bc5a0530769d62981
